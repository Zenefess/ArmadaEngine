...
al4 struct VERTEX331 {
	float x, y, z,
			r, sx, sy;
	ui8	t[4];
};

al4 struct VERTEX3311 {
	float x, y, z,
			r, sx, sy;
	ui8	t[4];
	ui32	b;
...
al4 struct VERTEX332 {
	float x, y, z,
			r, sx, sy,
			u, v;
};

al4 struct VERTEX3322 {
	float x, y, z,
			r, sx, sy,
			u1, v1, u2, v2;
};

al8 struct VERTEX42211 {
	VEC4Df textCol;
	VEC2Df origin;
	VEC2Df charScale;
	float  rotAngle;
