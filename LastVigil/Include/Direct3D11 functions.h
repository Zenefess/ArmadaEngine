...
al32 struct CLASS_GPU {
	...
	D3D_FEATURE_LEVEL               d3dFL[4] { (D3D_FEATURE_LEVEL)NULL, D3D_FEATURE_LEVEL_12_1, D3D_FEATURE_LEVEL_12_0, D3D_FEATURE_LEVEL_11_1 };
...
//	ui32 flags = (NDEBUG ? NULL : D3D11_CREATE_DEVICE_DEBUG), msaaQuality[33] {}, uiMSAA = 1;
	ui32 flags = (NDEBUG ? D3D11_CREATE_DEVICE_SINGLETHREADED : D3D11_CREATE_DEVICE_SINGLETHREADED | D3D11_CREATE_DEVICE_DEBUG), msaaQuality[33] {}, uiMSAA = 1;
...
//		dxgiDev->SetGPUThreadPriority(7);
		...
		ren.gui = &gui;
		gui._Initialise();
		ren.bufVertex = buf.CreateVertex(&ren.vCube, sizeof(VERTEX31), 1, 1);
